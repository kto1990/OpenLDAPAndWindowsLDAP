...
OpenLDAP::OpenLDAP(const std::string& _host_name, const std::string& _user_name, const std::string& _password, CONNECTION_TYPES _conn_type)
	:BaseLDAP(_host_name, _user_name, _password, _conn_type)
{
	this->class_name = "OpenLDAP";
}
